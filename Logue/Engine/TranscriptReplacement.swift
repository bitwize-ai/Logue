...
/// But the buffer is capped at `AppConstants.Diarization.maxAudioBufferSeconds` to bound memory,
/// and once it is full the rest of the meeting's audio is dropped on the floor. Handing the whole
